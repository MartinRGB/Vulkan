 ...
 *
 * MoltenGL supports several levels of license scope. Depending on the license scope purchased,
 ...
 * for each developer.
 */
void glActivateMoltenGLLicenseMGL(const GLchar* licenseID,
								 const GLchar* licenseKey,
								 GLboolean acceptLicenseTermsAndConditions);

/**
 * This function allows you to enter up to four MoltenGL license ID and license key pairs
 ...
 * of the MoltenGL license agreement:
 *
...
#	ifdef MGL_LICENSE_ID
#		ifdef MGL_LICENSE_KEY
	glActivateMoltenGLLicenseMGL(MGL_STR(MGL_LICENSE_ID), MGL_STR(MGL_LICENSE_KEY), MGL_LICENSE_ACCEPT_TERMS_AND_CONDITIONS);
#		endif
#	endif

#	ifdef MGL_LICENSE_ID_1
#		ifdef MGL_LICENSE_KEY_1
	glActivateMoltenGLLicenseMGL(MGL_STR(MGL_LICENSE_ID_1), MGL_STR(MGL_LICENSE_KEY_1), MGL_LICENSE_ACCEPT_TERMS_AND_CONDITIONS);
#		endif
#	endif

#	ifdef MGL_LICENSE_ID_2
#		ifdef MGL_LICENSE_KEY_2
	glActivateMoltenGLLicenseMGL(MGL_STR(MGL_LICENSE_ID_2), MGL_STR(MGL_LICENSE_KEY_2), MGL_LICENSE_ACCEPT_TERMS_AND_CONDITIONS);
#		endif
#	endif

#	ifdef MGL_LICENSE_ID_3
#		ifdef MGL_LICENSE_KEY_3
	glActivateMoltenGLLicenseMGL(MGL_STR(MGL_LICENSE_ID_3), MGL_STR(MGL_LICENSE_KEY_3), MGL_LICENSE_ACCEPT_TERMS_AND_CONDITIONS);
#		endif
#	endif
}
